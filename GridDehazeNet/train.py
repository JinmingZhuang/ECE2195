...
for epoch in range(num_epochs):
    ...
    torch.save(net.state_dict(), '{}_haze_{}_{}_finetune'.format(category, network_height, network_width))
    ...
    if val_psnr >= old_val_psnr:
        torch.save(net.state_dict(), '{}_haze_best_{}_{}_finetune'.format(category, network_height, network_width))
