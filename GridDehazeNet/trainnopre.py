...
from modelnopre import GridDehazeNet
...
# --- Multi-GPU --- #
net = net.to(device)
summary(net, (3, 620, 460))
net = nn.DataParallel(net, device_ids=device_ids)


# --- Define the perceptual loss network --- #
vgg_model = vgg16()#vgg16(pretrained=True).features[:16]
...
print(loss_network.parameters())


# --- Load the network weight --- #
# try:
#     net.load_state_dict(torch.load('{}_haze_best_{}_{}_finetune'.format(category, network_height, network_width)))
#     print('--- weight loaded ---')
# except:
...
for epoch in range(num_epochs):
    ...
    torch.save(net.state_dict(), '{}_haze_{}_{}_finetune_nopre'.format(category, network_height, network_width))
    ...
    if val_psnr >= old_val_psnr:
        torch.save(net.state_dict(), '{}_haze_best_{}_{}_finetune_nopre'.format(category, network_height, network_width))
